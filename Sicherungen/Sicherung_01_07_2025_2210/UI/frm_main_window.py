...
class Ui_frm_main_window(object):
    def setupUi(self, frm_main_window):
        ...
        self.work.setGeometry(QRect(0, 0, 98, 76))
        ...
        self.other.setGeometry(QRect(0, 0, 98, 76))
        ...
        self.finished_tasks.setGeometry(QRect(0, 0, 98, 76))
        ...
        self.ded_description.setCalendarPopup(False)
