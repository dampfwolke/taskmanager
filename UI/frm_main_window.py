...
class Ui_frm_main_window(object):
    def setupUi(self, frm_main_window):
        ...
        frm_main_window.resize(607, 556)
        font = QFont()
        ...
        sizePolicy.setHeightForWidth(self.wg_main_tasks.sizePolicy().hasHeightForWidth())
        self.wg_main_tasks.setSizePolicy(sizePolicy)
        ...
        self.high.setGeometry(QRect(0, 0, 273, 328))
        ...
        self.medium.setGeometry(QRect(0, 0, 290, 328))
        ...
        self.low.setGeometry(QRect(0, 0, 290, 328))
        ...
        sizePolicy.setHeightForWidth(self.wg_main_descripton.sizePolicy().hasHeightForWidth())
        self.wg_main_descripton.setSizePolicy(sizePolicy)
        self.verticalLayout_4 = QVBoxLayout(self.wg_main_descripton)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.verticalLayout_4.setContentsMargins(-1, 0, -1, 0)
        self.lb_description = QLabel(self.wg_main_descripton)
